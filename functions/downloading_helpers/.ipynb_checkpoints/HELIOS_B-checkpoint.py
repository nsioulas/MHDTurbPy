...
def LoadTimeSeriesHELIOS_B_particles(start_time,
                                 end_time):
    """ 
    Load HELIOS_B Plasma Data 
...
def LoadHighResMagHELIOS_B(start_time,
                       end_time,
                       verbose = True):
    """ 
    Load HELIOS_B Plasma Data 
...
def LoadMagHELIOS_B(start_time,
                    end_time,
                    verbose = True):
    """ 
    Load HELIOS_B Plasma Data 
...
def LoadTimeSeriesHELIOS_B(start_time, 
                      end_time, 
                      settings, 
    ...
    """" 
    Load Time Series from HELIOS_B sc
    ...
    try:
        ...
        dfmag, dfmag1, infos = LoadMagHELIOS_B(pd.Timestamp(t0),
                                                  pd.Timestamp(t1),
                                                  verbose = True)
    ...
    try:        
        ...
        dfpar, dfdis     = LoadTimeSeriesHELIOS_B_particles(pd.Timestamp(t0),
                                                        pd.Timestamp(t1))
