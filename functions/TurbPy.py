...
def est_5_pt_sfuncs(
    B_df,
    dt,
    func_params={"dt_step": 1, "max_qorder": 8, "five_points_sfunc": True, "return_Bmod": True},
):
    ...
    res = turb.structure_functions_parallel(
        B_df,
        lags,
    ...
    # New API (dict) -> keep old outputs unchanged
    sfn = np.asarray(res["SF_trace"], dtype=float)  # (n_scales, Q)
    counts = np.asarray(res["counts_Bmod"], dtype=int)

    SF_trace = sfn.T  # (Q, n_scales), as before

    SF_dBmod = res.get("SF_Bmod", None)
    if SF_dBmod is None:
        SF_mod = None
    else:
        SF_mod = np.asarray(SF_dBmod, dtype=float).T  # (Q, n_scales), as before

    Q = SF_trace.shape[0]
    if Q >= 4:
        SDK_vec = SF_trace[3] / (SF_trace[1] ** 2)
        if SF_mod is None:
            SDK_mod = None
        else:
            SDK_mod = SF_mod[3] / (SF_mod[1] ** 2)
    else:
        SDK_vec = np.full(SF_trace.shape[1], np.nan, dtype=float)
        SDK_mod = None if SF_mod is None else np.full(SF_mod.shape[1], np.nan, dtype=float)
...
def _poly_deriv(coef: np.ndarray, x_ln: np.ndarray) -> np.ndarray:
    r"""
    Derivative of a polynomial p(x)p(x) evaluated at x=\ln(r/\text{AU})x=\ln(r/\text{AU}).

    Parameters
    ----------
    coef : ndarray
        np.polyval-style coefficients for p(x)p(x).
    x_ln : ndarray
    ...
    Notes
    -----
    If y=\ln Yy=\ln Y is modeled by p(x)p(x), then
    \[
      \frac{d\ln Y}{d\ln r} = p'(x),\qquad x=\ln(r/\text{AU}).
    \]
    For a non-log variable zz modeled directly by p(x)p(x),
    \[
...
def _design(x_ln: np.ndarray, deg: int) -> np.ndarray:
    r"""
    Vandermonde design V_{ij}=x^{d-j}V_{ij}=x^{d-j} for polynomial degree `deg` in x=ln(r/AU)x=\ln(r/\text{AU}).
    """
...
def _latex_poly_inline(coef: np.ndarray, var: str, expr: str, logy: bool) -> str:
    r"""
    Inline LaTeX for polynomial p(x)p(x) with x=\ln(r/\text{AU})x=\ln(r/\text{AU}).
    Prints either \ln(\text{expr})=...\ln(\text{expr})=... or \text{expr}=...\text{expr}=... depending on `logy`.
    """
...
def _latex_poly_equation(coef: np.ndarray, expr: str, logy: bool) -> str:
    r"""
    Display equation for polynomial p(x)p(x), x=\ln(r/\text{AU})x=\ln(r/\text{AU}).
    """
    if coef is None or len(coef) == 0:
        return r"\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}\begin{equation}\end{equation}"
    d = len(coef) - 1
    parts = []
    for i, c in enumerate(coef):
        p = d - i
...
def _latex_piecewise_inline(b: float, k1: float, dk: float, xb: float, expr: str) -> str:
    ...
    \[
      ...
      \end{cases}
    \]
    with p_2=p_1+\Delta kp_2=p_1+\Delta k and continuity A_2=A_1 (r_b/\text{AU})^{p_1-p_2}A_2=A_1 (r_b/\text{AU})^{p_1-p_2}.
    """
    A1   = float(np.exp(b))
    p1   = float(k1)
    p2   = float(k1 + dk)
...
def _bin_mean_and_count(
    ...
    *,
    ...
    r"""
    Log-spaced binning in x=r/\text{AU}x=r/\text{AU}, arithmetic mean of yy, and counts.
    ...
    require_pos : bool
        If True, discard non-positive yy before averaging (needed for log fits).
...
def _loglike_wls(y: np.ndarray, V: np.ndarray, params: np.ndarray, w: np.ndarray) -> float:
    r"""
    Gaussian WLS log-likelihood under heteroskedastic weights w_iw_i.
    ...
    \]
    We use  \hat\sigma^2 = \frac{1}{n}\sum_i w_i (y_i - V_i\theta)^2 \hat\sigma^2 = \frac{1}{n}\sum_i w_i (y_i - V_i\theta)^2 as scale.
...
def _fgls_fit(
    ...
    *,
    ...
    r"""
    One-iteration Feasible GLS (FGLS) for a polynomial in x=\ln(r/\text{AU})x=\ln(r/\text{AU}).
...
def _blocked_cv_lppd_fgls(
    ...
    *,
    ...
    For test fold with design V_{\text{te}}V_{\text{te}} and variance model \ln\sigma^2= q(x)\ln\sigma^2= q(x):
    \[
...
def _fit_piecewise_given_w(x: np.ndarray, y: np.ndarray, w: np.ndarray, xb: float):
    r"""
    Weighted LS for fixed breakpoint x_bx_b with design [1, x, (x−xb)+][1,\ x,\ (x-x_b)_+].
...
def _fit_piecewise_powerlaw(
    ...
    *,
    ...
    r"""
    Two-part power law on \ln Y\ln Y vs x=\ln(r/\text{AU})x=\ln(r/\text{AU}) with hinge at xbx_b:
...
def _blocked_cv_lppd_piecewise(
    ...
    *,
    ...
    r"""
    Contiguous K-fold CV LPPD for the hinge model in \ln Y\ln Y.
...
def _choose_among_degrees_fgls(
    ...
    *,
    ...
    Accept a higher degree d'd' over incumbent dd only if
    \[
