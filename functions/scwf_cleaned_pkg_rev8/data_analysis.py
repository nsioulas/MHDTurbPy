...
This module keeps the notebook-facing compatibility alias
``run_logscale_filterbank_analysis`` and forwards all work to the single SCWF
backend implemented in ``three_D_funcs.py``.
"""
...
merge_scale_binned_accumulators = _IMPL.merge_scale_binned_accumulators
finalize_scale_binned_accumulator = _IMPL.finalize_scale_binned_accumulator
reduce_saved_interval_accumulators = _IMPL.reduce_saved_interval_accumulators
coefficient_store_to_dataframe = _IMPL.coefficient_store_to_dataframe
merge_compact_coefficient_stores = _IMPL.merge_compact_coefficient_stores
reduce_compact_coefficient_store = _IMPL.reduce_compact_coefficient_store
reduce_saved_interval_coefficient_stores = _IMPL.reduce_saved_interval_coefficient_stores
reduce_saved_interval_coefficients = _IMPL.reduce_saved_interval_coefficients
...
__all__ = [
    ...
    "merge_scale_binned_accumulators",
    "finalize_scale_binned_accumulator",
    "reduce_saved_interval_accumulators",
    "coefficient_store_to_dataframe",
    "merge_compact_coefficient_stores",
    "reduce_compact_coefficient_store",
    "reduce_saved_interval_coefficient_stores",
    "reduce_saved_interval_coefficients",
]
