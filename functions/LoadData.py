...
def LoadTimeSeriesULYSSES(
    ...
    if os.path.exists("./ulysses_data"):
        ...
        working_dir = os.getcwd()
        os.makedirs(str(Path(working_dir).joinpath("ulysses_data")), exist_ok=True)
